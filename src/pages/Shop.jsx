...
export default function Shop() {
  ...
  const filtered = products.filter((p) => (activeFilter === 'All' ? true : p.category === activeFilter));
  ...
  return (
    <div className="bg-white px-5 sm:px-10 md:px-16 lg:px-20 py-4">
      <main className="w-full max-w-7xl mx-auto">
        <header className="mt-8 sm:mt-12 md:mt-16 lg:mt-20">
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-black">ALL PRODUCTS</h1>
          <p className="text-xs sm:text-sm text-[#888888] mt-2 md:mt-3">Showing {paginated.length} of {filtered.length} products</p>

          <div className="flex flex-wrap items-center gap-2 sm:gap-3 md:gap-4 mt-6 sm:mt-8 md:mt-10">
            ...
            <select className="ml-auto text-xs sm:text-sm px-3 py-1.5 border border-[#DDDDDD] rounded bg-white text-black">
        ...
        <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 sm:gap-4 md:gap-6 mt-8 sm:mt-12 md:mt-16 lg:mt-20">
        ...
        <div className="flex justify-center items-center gap-2 sm:gap-3 md:gap-4 mt-12 sm:mt-16 md:mt-20 pb-8">
          <button onClick={prevPage} disabled={page === 1} className="text-xs sm:text-sm md:text-base text-black disabled:opacity-50 px-2 py-1.5">
            ←
          </button>
          ...
          <button onClick={nextPage} disabled={page === totalPages} className="text-xs sm:text-sm md:text-base text-black disabled:opacity-50 px-2 py-1.5">
            →
          </button>
        </div>
      </main>
